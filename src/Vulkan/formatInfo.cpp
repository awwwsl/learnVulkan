...
constexpr const static formatInfo formatInfos_v1_0[] = {
    ...
    {2, 0, 8, 0}, // VK_FORMAT_D32_SFLOAT_S8_UINT = 130,//24 bits are unused if
                  // data is of linear tiling therefore sizePerPixel is 8
...
#define LVK_FORMAT_INFO_MAX_ENUM 184
};

const formatInfo formatInfo::FormatInfo(VkFormat format) {
  if (format > LVK_FORMAT_INFO_MAX_ENUM) {
#ifndef NDEBUF
    printf("[ FormatInfo ] ERROR: formatInfo::FormatInfo() only supports "
           "definite formats "
           "provided by VK_VERSION_1_0.\n");
#endif
    return formatInfos_v1_0[0];
  }
...
// }
//
// const formatInfo formatInfo::getSizeMemory(VkFormat format) {
//   if (format > LVK_FORMAT_INFO_MAX_ENUM)
//     return formatInfos_v1_0[0];
//   return formatInfos_v1_0[format];
// }
